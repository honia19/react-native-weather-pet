...
const SulfurPollutionView = inject(
  'locationStore',
  'pollutionAirStore'
)(
  observer(({ locationStore, pollutionAirStore }) => {
    ...
    const setPullutionInfo = (dataPollution: Object): void => {
      ...
      if (errorMsg) {
        ...
        pollutionAirStore.setSO2PollutionData(dataPollution.data);
      }
    };
...
export default SulfurPollutionView;
